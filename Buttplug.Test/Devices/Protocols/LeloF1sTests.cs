// <copyright file="LeloF1sTests.cs" company="Nonpolynomial Labs LLC">
    ...
    public class LeloF1sTests
    {
        ...
        public async Task TestStopDeviceCmd()
        {
            var expected =
                ...
                {
                    (new byte[] { 0x01, 0x32, 0x32 }, Endpoints.Tx),
                };
            ...
            expected =
                new List<(byte[], string)>()
                {
                    (new byte[] { 0x01, 0x00, 0x00 }, Endpoints.Tx),
                };
        ...
        public async Task TestVibrateCmd()
        {
            var expected =
                new List<(byte[], string)>()
                {
                    (new byte[] { 0x01, 0x32, 0x00 }, Endpoints.Tx),
                };

            await testUtil.TestDeviceMessage(VibrateCmd.Create(4, 2, 0.5, 1), expected, false);
        }
