// <copyright file="RealovTests.cs" company="Nonpolynomial Labs LLC">
    ...
    public class RealovTests
    {
        ...
        public async Task TestStopDeviceCmd()
        {
            var expected =
                ...
                {
                    (new byte[] { 0xC5, 0x55, 0x19, 0xAA }, Endpoints.Tx),
                };
            ...
            expected =
                new List<(byte[], string)>()
                {
                    (new byte[] { 0xC5, 0x55, 0x00, 0xAA }, Endpoints.Tx),
                };
