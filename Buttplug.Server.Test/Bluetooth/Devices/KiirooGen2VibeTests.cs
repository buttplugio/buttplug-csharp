...
namespace Buttplug.Server.Test.Bluetooth.Devices
{
    ...
    public class KiirooGen2VibeTests
    {
        ...
        public void Pearl2Test()
        {
            ...
            Assert.AreEqual(bleInfo.Characteristics[(uint)KiirooGen2VibeBluetoothInfo.Chrs.Tx],
                inter.LastWriten[0].Characteristic);
            Assert.AreEqual(new byte[] { 0x32, 0x00, 0x00 }, inter.LastWriten[0].Value);
            Assert.False(inter.LastWriten[0].WriteWithResponse);
            inter.LastWriten.Clear();
            ...
            Assert.AreEqual(bleInfo.Characteristics[(uint)KiirooGen2VibeBluetoothInfo.Chrs.Tx],
                inter.LastWriten[0].Characteristic);
            Assert.AreEqual(new byte[] { 0x64, 0x00, 0x00 }, inter.LastWriten[0].Value);
            Assert.False(inter.LastWriten[0].WriteWithResponse);
            inter.LastWriten.Clear();
            ...
            Assert.AreEqual(bleInfo.Characteristics[(uint)KiirooGen2VibeBluetoothInfo.Chrs.Tx],
                inter.LastWriten[0].Characteristic);
            Assert.AreEqual(new byte[] { 0x19, 0x00, 0x00 }, inter.LastWriten[0].Value);
            Assert.False(inter.LastWriten[0].WriteWithResponse);
            inter.LastWriten.Clear();
            ...
            Assert.AreEqual(bleInfo.Characteristics[(uint)KiirooGen2VibeBluetoothInfo.Chrs.Tx],
                inter.LastWriten[0].Characteristic);
            Assert.AreEqual(new byte[] { 0x4B, 0x00, 0x00 }, inter.LastWriten[0].Value);
            Assert.False(inter.LastWriten[0].WriteWithResponse);
            inter.LastWriten.Clear();
